...
<img width="1366" height="640" alt="Image 8 - Secondary region (Canada region) – Recovery Point created in SecondaryEC2VaultCanada" src="https://github.com/user-attachments/assets/92c8ba21-df89-4669-9f74-25f3c31fc643" />
  <p align="center">
    <i><strong>Image 8 : </strong> Secondary region (Canada region) – Recovery Point created in SecondaryEC2VaultCanada</i>
  </p><br>
...
<img width="1366" height="507" alt="Image 8 1 - Secondary region (Canada region) – Recovery Point list" src="https://github.com/user-attachments/assets/1b388c2c-e5dc-4f50-84c5-4ec78e2c3cdd" />
  <p align="center">
    <i><strong>Image 8.1 : </strong> Secondary region (Canada region) – Recovery Point list</i>
  </p><br>


<img width="1366" height="643" alt="Image 8 2 -  Secondary region (Canada region) – SecondaryEC2VaultCanada – Recovery Point = an ami is generated" src="https://github.com/user-attachments/assets/b2acaacf-e201-4b01-9fc6-f0ac844a8d63" />
  <p align="center">
    <i><strong>Image 8.2 : </strong> Secondary region (Canada region) – SecondaryEC2VaultCanada – Recovery Point = an ami is generated</i>
  </p><br>

Click on the ami ID.

It was verified whether the backup accurately corresponded to the **EC2 instance launched in the Frankfurt region.** <br>
The HTML application page that was tested in Europe (Frankfurt – eu-central-1) should also be displayed in Canada (Central – ca-central-1) when an **EC2 instance is launched using the AMI generated through Cross-Region Backup Replication.**

So, launch an EC2 using **ami.**

<img width="1364" height="638" alt="Image 8 3 - Secondary region (Canada region) – Launching EC2 using ami generated by Cross-Region Backup Replication" src="https://github.com/user-attachments/assets/b437ce62-b09e-4e79-b89a-85fd37ba22d9" />
  <p align="center">
    <i><strong>Image 8.3 : </strong> Secondary region (Canada region) – Launching EC2 using ami generated by Cross-Region Backup Replication</i>
  </p><br>

Copy it’s public ip and run in the browser. 
...
&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;❓  &ensp;After configuring the copy rule, the recovery point did not appear immediately in the Canada (Central) vault, which initially caused confusion. The reason behind it was identified: only new backups are eligible for replication, whereas existing backups are not copied.

&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;❓  &ensp;In addition, there was no option to trigger the copy instantly, so replication started later as per the backup schedule.

**Issue Fixed:**  <br>

&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;✔  &ensp;Additional on-demand backups were created in the primary region (Frankfurt), which successfully triggered the copy jobs.

&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;✔  &ensp;This ensured that recovery points were eventually replicated to the secondary region (Canada).

<br>

**2.	Restore Failure via AWS Backup Console**

&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;❓  &ensp;While attempting to restore the EC2 instance directly from the recovery point in the Canada (Central) region using the AWS Backup console, the process failed.

&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;❓  &ensp;The restore from AWS Backup console failed because the original VPC, subnet, and security groups from Frankfurt were not available in the Canada region, causing a configuration mismatch.

**Issue Fixed:** 

&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;✔  &ensp;The issue was resolved by navigating to the EC2 → AMIs section in the Canada region. 

&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;✔  &ensp;The AMI generated through the cross-region backup was available there. 

&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;✔  &ensp;A new EC2 instance was successfully launched directly from this AMI, and the test application page was verified to be identical to the one in the primary region (Frankfurt).
