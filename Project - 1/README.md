...
**Document:** Open or Download PDF - [Project - Cross-Region Backup Replication for EC2 using AWS Backup](#https://github.com/koustubhjuvekar/My-Projects/blob/afe2580fbb3ab3964aeca3c9777b1455952255ab/Project%20-%201/Project%20-%20Cross-Region%20Backup%20Replication%20for%20EC2%20using%20AWS%20Backup.pdf) 
<br>
## 🎯 `Objective`  
...
❓  &ensp;After configuring the copy rule, the recovery point did not appear immediately in the Canada (Central) vault, which initially caused confusion. The reason behind it was identified: only new backups are eligible for replication, whereas existing backups are not copied.

❓  &ensp;In addition, there was no option to trigger the copy instantly, so replication started later as per the backup schedule.
...
✔  &ensp;The issue was resolved by navigating to the EC2 → AMIs section in the Canada region. 

✔  &ensp;The AMI generated through the cross-region backup was available there. 

✔  &ensp;A new EC2 instance was successfully launched directly from this AMI, and the test application page was verified to be identical to the one in the primary region (Frankfurt).
...
<b><strong>- - T H E  &ensp;   E N D - -</strong></b>
