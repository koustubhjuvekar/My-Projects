...
- &ensp;&ensp;Configure the instance with the following details:
  &emsp;&emsp;- &emsp;**Name:** `Project2-EC2Instance`
  &emsp;&emsp;- &emsp;**AMI:** `Amazon Linux 2 (Free Tier Eligible)`
  &emsp;&emsp;- &emsp;**Instance Type:** `t2.micro`
  &emsp;&emsp;- &emsp;**Key Pair:** Select existing or create a new one.
